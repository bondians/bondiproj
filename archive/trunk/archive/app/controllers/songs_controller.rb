class SongsController < ApplicationController
  ...
  def stream_one_song
   ...
   respond_to do |format|
    format.mp3 {send_file song.file, :content_type => "audio/mpeg", :filename=> File.basename(song.file), :disposition => :inline}
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.mp3 {send_file @song.file, :type => "audio/mpeg", :filename=> File.basename(@song.file), :disposition => :inline}
