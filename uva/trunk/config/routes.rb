...
#  map.resources :javascripts, :collection => { :dynamic_accounts => :get }
  ...
  #map.resources :jobs 
  map.resources :jobs, :collection => { :design => :get, :copy => :get, \
    :press => :get, :bindery => :get, :ship => :get, \
      :completed => :get, :current => :get, :search => :get, :search_by_school => :get }, \
      :member => { :complete_step => :put, :new_from_template => :get }
