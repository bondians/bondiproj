module Goldberg
  class Permission < ActiveRecord::Base
    ...
    has_many :content_pages, :class_name=>"Goldberg::ContentPages", :foreign_key => :permission_id
    has_many :site_controllers, :class_name=>"Goldberg::SiteController", :foreign_key => :permission_id
    has_many :controller_actions, :class_name=>"Goldberg::ControllerAction", :foreign_key => :permission_id
